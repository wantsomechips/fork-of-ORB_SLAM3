# Keep this script callable from both add_subdirectory mode and script mode.
if(NOT DEFINED PANGOLIN_CMAKE_DIR)
    set(PANGOLIN_CMAKE_DIR "${CMAKE_CURRENT_LIST_DIR}")
endif()
set(PANGOLIN_EMBED_SHADER_SCRIPT "${PANGOLIN_CMAKE_DIR}/EmbedShaderFiles.cmake")
if(NOT DEFINED PANGOLIN_SOURCE_DIR)
    set(PANGOLIN_SOURCE_DIR "${CMAKE_SOURCE_DIR}")
endif()
...
function(embed_shader_files_rule output shader_files)
    ...
    add_custom_command(
        OUTPUT ${output}
        DEPENDS ${shader_files} ${PANGOLIN_EMBED_SHADER_SCRIPT}
        COMMAND
            ${CMAKE_COMMAND} -DINPUT_SHADER_FILES="${escaped_shader_files}"
                             -DOUTPUT_SRC_FILE=${output}
                             -DPREFIX_TO_STRIP=${PANGOLIN_SOURCE_DIR}
                             -DPANGOLIN_CMAKE_DIR=${PANGOLIN_CMAKE_DIR}
                             -P ${PANGOLIN_EMBED_SHADER_SCRIPT}
